...
/**
 * An example of using the {@code AmazonS3EncryptionClient} in authenticated encryption
 * mode with the FIPS-certified BouncyCastle implementation.
 */
public class FipsAuthenticatedEncryptionTest {
    ...
    public void testIt() throws Exception {
        ...
        // The important bits for this demonstration:
                .withCryptoConfiguration(new CryptoConfiguration()
                        ...
                        .withAlwaysUseCryptoProvider(true)   // ACTUALLY use it despite the SDK's preference for the non-FIPS-certified provider when doing AES/GCM.
